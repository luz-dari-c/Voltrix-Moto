 ...
 * @author gameV
 */
public class BwsRoja extends javax.swing.JFrame {

    private Moto motoActual;

    /**
     * Creates new form BwsRoja
     */
    public BwsRoja() {
        initComponents();
        ...
        Map<TipoColorMoto, Integer> conteo = controller.contarPorColor(TipoMoto.SCOOTER);
        ...
        if (!motos.isEmpty()) {
            ...
            String ruta = switch (color) {
                case ROJO ->
                    "/Images/web-ares-new-1024x1024-removebg-preview (2).png";
                case NEGRO ->
                    "/Images/Scooter-negra.png";
                case BLANCO ->
                    "/Images/Scooter-blanca.png";
                case VERDE ->
                    "/Images/Scooter-verde.png";
                default ->
                    "";
            };
    ...
    private void initComponents() {
        ...
        MotoFoto.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/web-ares-new-1024x1024-removebg-preview (2).png"))); // NOI18N
        jPanel1.add(MotoFoto, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 120, 720, 420));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BwsRoja.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
