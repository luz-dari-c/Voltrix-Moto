...
public class VerdeMinima extends javax.swing.JFrame {
    ...
    public VerdeMinima() {
        ...
        Map<TipoColorMoto, Integer> conteo = controller.contarPorColor(TipoMoto.NAKED);
        ...
        if (!motos.isEmpty()) {
            ...
            String ruta = switch (color) {
                case ROJO ->
                    "/Images/Naked-roja.png";
                case NEGRO ->
                    "/Images/Naked-negra.png";
                case BLANCO ->
                    "/Images/Naked-blanca.png";
                case VERDE ->
                    "/Images/motovelde-removebg-preview.png";
                default ->
                    "";
            };
    ...
    private void initComponents() {
        ...
        jPanel2.add(Carrito7, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 140, 70, 40));
