...
public class LittleNegra extends javax.swing.JFrame {
    ...
    public LittleNegra() {
        ...
        Map<TipoColorMoto, Integer> conteo = controller.contarPorColor(TipoMoto.CHOPPER);
        ...
        if (!motos.isEmpty()) {
            ...
            String ruta = switch (color) {
                case ROJO ->
                    "/Images/Chopper-roja.png";
                case NEGRO ->
                    "/Images/moto (2).png";
                case BLANCO ->
                    "/Images/Chopper-blanca.png";
                case VERDE ->
                    "/Images/Chopper-verde.png";
                default ->
                    "";
            };
    ...
    private void initComponents() {
        ...
        jPanel2.add(Carrito5, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 140, 70, 40));
