 ...
 * @author gameV
 */
public class KawasakiVerde extends javax.swing.JFrame {

    private Moto motoActual;

    /**
     * Creates new form KawasakiVerde
     */
    public KawasakiVerde() {
        initComponents();
        ...
        Map<TipoColorMoto, Integer> conteo = controller.contarPorColor(TipoMoto.SEMIDEPORTIVA);
        ...
        if (!motos.isEmpty()) {
            ...
            String ruta = switch (color) {
                case ROJO ->
                    "/Images/Semideportiva-roja.png";
                case NEGRO ->
                    "/Images/Semideportiva-negra.png";
                case BLANCO ->
                    "/Images/Semideportiva-blanca.png";
                case VERDE ->
                    "/Images/2025-Kawasaki-Ninja-ZX-6R-ABS-KRT-Edition3-removebg-preview.png";
                default ->
                    "";
            };
    ...
    private void initComponents() {
        ...
        MotoFoto.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/2025-Kawasaki-Ninja-ZX-6R-ABS-KRT-Edition3-removebg-preview.png"))); // NOI18N
        jPanel1.add(MotoFoto, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 120, 720, 420));
        ...
        jPanel2.add(Carrito3, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 140, 70, 40));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(KawasakiVerde.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new KawasakiVerde().setVisible(true);
            }
        });
    }
