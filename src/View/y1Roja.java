 ...
 * @author gameV
 */
public class y1Roja extends javax.swing.JFrame {

    private Moto motoActual;

    /**
     * Creates new form y1Roja
     */
    public y1Roja() {
        initComponents();
        ...
        Map<TipoColorMoto, Integer> conteo = controller.contarPorColor(TipoMoto.DEPORTIVA);
        ...
        if (!motos.isEmpty()) {
            ...
            String ruta = switch (color) {
                case ROJO ->
                    "/Images/motorojita-removebg-preview.png";
                case NEGRO ->
                    "/Images/Deportiva-negra.png";
                case BLANCO ->
                    "/Images/Deportiva-blanca.png";
                case VERDE ->
                    "/Images/Deportiva-verde.png";
                default ->
                    "";
            };
    ...
    private void initComponents() {
        ...
        MotoFoto.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/motorojita-removebg-preview.png"))); // NOI18N
        ...
        jPanel2.add(Carrito4, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 140, 70, 40));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(y1Roja.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
